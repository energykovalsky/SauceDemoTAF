...
public class ProductCardComponent
{
    ...
    public ProductCardComponent(IWebElement root)
    {
        _root = root;
    }
    ...
    public bool IsInCart => _root.FindElement(ButtonLocator).Text.Equals("Remove");
    ...
    public void Open()
    {
        _root.FindElement(NameLocator).Click();
    }
